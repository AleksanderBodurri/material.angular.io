...
export class Carousel implements AfterContentInit {
  ...
  @ContentChildren(CarouselItem) items: QueryList<CarouselItem> | undefined;
  @ViewChild('contentWrapper') wrapper: ElementRef | undefined;
  position = 0;
  showPrevArrow = false;
  showNextArrow = true;
  ...
  set index(i: number) {
    ...
    if (this.items) {
      lastVisibleIndex = this.items.length;
    }
